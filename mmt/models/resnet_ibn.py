...
__all__ = ['ResNetIBN', 'resnet_ibn50a', 'resnet_ibn101a', 'wacv_model_ibn', 'wacv_model_ibn_2scale']
...
class wacv_model_ibn_2scale(nn.Module):
    __factory = {
        '50a': resnet50_ibn_a,
        '101a': resnet101_ibn_a
    }
    ...
    def forward(self, x):
        ...
        return predict, \
               f_p1, f_p2, \
               l_p1, l_p2, l_p2_c1, l_p2_c2, l_p2_s1, l_p2_s2
